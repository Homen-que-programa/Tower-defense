                                    ...
                                    if (!(matrizPrecoTorres[_torreEscolhida][0] > recursosAzul.ouro[0] || matrizPrecoTorres[_torreEscolhida][1] > recursosAzul.comida[0] || matrizPrecoTorres[_torreEscolhida][2] > recursosAzul.recurso[0])) {
                                        ...
                                        if (_torreEscolhida === 0) {
                                            ...
                                            if (quantiaTorreAzul <= quantiaTorreLimite - _espacoOcupado) {
                                                ...
                                                if (verificacao) {
                                                    criarTorre(_x, _y, 400, 1500, 800, 0, 0, 0, _torreTamanho, 'background-color: rgb(145, 84, 35);', _espacoOcupado, ['A', 'azul', ['V', 'vermelho']], 'nenhum', [], false, false, 'nenhum', 'Cercado', _torreEscolhida, [0, 'n', 'n'], [false])
                                                }
                                            }
                                            ...
                                            if (quantiaTorreAzul <= quantiaTorreLimite - _espacoOcupado) {
                                                ...
                                                if (verificacao) {
                                                    criarTorre(_x, _y, 400, 1500, 6000, 30, 2000, 500, _torreTamanho, 'background-color: rgb(106, 151, 48);', _espacoOcupado, ['A', 'azul', ['V', 'vermelho']], 'area', [100], true, false, 'nenhum', 'Homen que taca bomba', _torreEscolhida, [0, 0, 0], [false])
                                                }
                                            }
                                    ...
                                    if (!(matrizPrecoTorres[_torreEscolhida][0] > recursosVermelho.ouro[0] || matrizPrecoTorres[_torreEscolhida][1] > recursosVermelho.comida[0] || matrizPrecoTorres[_torreEscolhida][2] > recursosVermelho.recurso[0])) {
                                        ...
                                        if (_torreEscolhida === 0) {
                                            ...
                                            if (quantiaTorreAzul <= quantiaTorreLimite - _espacoOcupado) {
                                                ...
                                                if (verificacao) {
                                                    criarTorre(_x, _y, 400, 1500, 6000, 40, 1000, 500, _torreTamanho, 'background-color: rgb(106, 151, 48);', _espacoOcupado, ['V', 'vermelho', ['A', 'azul']], 'area', [100], true, false, 'nenhum', 'Homen que taca bomba', _torreEscolhida, [0, 0, 0], [false])
                                                }
                                            }
                                        } else if (_torreEscolhida === 4) {
                                            _espacoOcupado = 3
