...
var matrizUpigradesOuro = [
    [[0, 10, 20], [0, 10, 20], 1],
    [[10, 25, 50], [5, 15, 25], 2],
    [[25, 60, 100], [15, 30, 50], 3],
    [[80, 120, 250], [40, 60, 125], 4],
    [[200, 400, 650], [100, 200, 325], 5]
]
var matrizUpigradesComida = [
    [[20, 0, 10], [20, 0, 10], 1],
    [[50, 10, 25], [25, 10, 15], 2],
    [[100, 25, 60], [50, 15, 30], 3],
    [[250, 80, 120], [125, 40, 60], 4],
    [[650, 200, 400], [325, 100, 200], 5]
]
var matrizUpigradesRecurso = [
    [[5, 20, 5], [5, 20, 5], 1],
    [[20, 40, 20], [10, 20, 10], 2],
    [[50, 100, 50], [25, 50, 25], 3],
    [[115, 220, 115], [60, 110, 60], 4],
    [[300, 550, 300], [150, 275, 150], 5]
]
        ...
        if (matrizEscolhaVermelho[i] && origemEspaco === i) {
            if (numeroEscolha === 0) {
                if (recursosVermelho.ouro[0] >= matrizUpigradesOuro[0][0][0] && recursosVermelho.comida[0] >= matrizUpigradesOuro[0][0][1] && recursosVermelho.recurso[0] >= matrizUpigradesOuro[0][0][2]) {
                    ...
                    document.getElementById(`receber-broca-direita-${i+1}`).style.cssText += 'width: 400px;height: 125px;'
